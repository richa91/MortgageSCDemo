...
const artifacts = require('../../build/contracts/Mortgage.json')
const contract = require('truffle-contract')
let Mortgage = contract(artifacts);
...
window.onload = function() {
    ...
    $("#payMH").click(function() {
        makePayment($("#valueMH").val(),$("#payMHaddress").val());
    });

    $("#payIns").click(function() {
        makePayment($("#valueIssurer").val(),$("#payIssureraddress").val());
    });

    $("#payIRS").click(function() {
        makePayment($("#valueIRS").val(),$("#payIRSaddress").val());
    });
};
